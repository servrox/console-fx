...
> = {
  ...
  serviceReady: {
    ...
    slots: [
      ...
      [295, 34, 12, 70, "middle"], // state
      [24, 115, 16, 312], // endpoint
      [24, 167, 12, 117], // envLabel
      [24, 207, 12, 117], // runtimeLabel
      [24, 247, 12, 117], // regionLabel
  ...
  return useCompact
    ? {
        ...
        slots: descriptor.slots.map((slot, index) => {
          const [x, y, fontSize, safeWidth, anchor = "start"] =
            variant.slots[index]!;
          return {
            ...slot,
            x,
