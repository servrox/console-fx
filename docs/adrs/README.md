...
| ADR-0015 | [Separate content fit from output sizing](0015-separate-content-fit-from-output-sizing.md) | Proposed | Layout, measurement confidence, responsive carriers, render recipes, and fit previews | None |

ADR-0013 is reserved by open [PR #3](https://github.com/servrox/console-fx/pull/3). ADR-0015 is an independent responsiveness proposal; neither proposal is accepted by adding it to this index. Preserve both entries when the branches are reconciled.
