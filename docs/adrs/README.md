...
| ADR-0013 | [Use closed preset presentations](0013-use-closed-preset-presentations.md) | Proposed | Useful/artful cards, shared presentation data, slot schemas, and comparison baselines | None |
