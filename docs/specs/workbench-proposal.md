...
The test strategy and cleanup are a separate, authorized prerequisite. This
document proposes the next product structure; it does not describe the live site.
...
and core support, then applies shared editor policy. It runs again after edits, imports or renderer changes.
