...
| [Core](../../packages/console-fx/package.json)                | `@servrox/console-fx` 0.1.0                         | **No dependencies or peers**; public ESM entrypoints                                                     |
| [React adapter](../../packages/console-fx-react/package.json) | `@servrox/console-fx-react` 0.1.0                   | Core `workspace:^`; React peer `^19.0.0`                                                                 |
...
| [Next.js example](../../examples/next-app/package.json)       | `console-fx-next-example`; private consumer fixture | Core/adapter 0.1.0; Next.js/React/React DOM pins above; TypeScript and Node/React declaration pins above |
